...
import com.example.mydoctor.PatientDirectory.PatientInbox;
import com.example.mydoctor.PatientDirectory.PrescriptionList;
...
public class PatientHome extends AppCompatActivity {
    ...
    public void initRecyclerViewsForPatient(){
        ...
        list.add(new PatientHomeData("Pathologist",R.drawable.patho));
